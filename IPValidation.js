...
Note that leading zeros (e.g. 01.02.03.04) are considered invalid.
 Use https://regexr.com for help...
 The pattern below is working there...
*/

function isValidIP(str) {
	return /^(([0-9]|[1-9][0-9]|[1][0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|[1][0-9][0-9]|2[0-4][0-9]|25[0-5])$/.test(str);
}

console.log(isValidIP('1.0.0.0'));
